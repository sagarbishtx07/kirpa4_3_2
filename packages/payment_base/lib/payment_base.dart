...
abstract class PaymentBase {
  ...
  Future<void> initialized({
    ...
    required Future<dynamic> Function(List<dynamic>, {Map<String, dynamic>? billingOptions, Map<String, dynamic>? shippingOptions, Map<String, dynamic>? options}) checkout,
