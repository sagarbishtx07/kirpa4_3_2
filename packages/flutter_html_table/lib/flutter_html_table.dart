      ...
      return TableCellElement(
        style: context.elementName == "th"
            ? Style(
              ...
              ).merge(context.styledElement?.style ?? Style())
            : Style(
                verticalAlign: VerticalAlign.middle,
              ).merge(context.styledElement?.style ?? Style()),
        children: children,
...
Widget _layoutCells(
  ...
  finalColumnSizes +=
      List.generate(max(0, columnMax - finalColumnSizes.length), (_) => const IntrinsicContentTrackSize());
