import 'package:kirpa/screens/post/comment_modal_reply.dart';
import 'package:kirpa/store/auth/auth_store.dart';
import 'package:kirpa/store/post_comment/post_comment_store.dart';
      ...
      return Observer(builder: (_) {
        return _authStore.isLogin
            ? InkWell(
                ...
                child: Text(translate('comment_reply'), style: Theme.of(context).textTheme.labelSmall),
              )
            : InkWell(
