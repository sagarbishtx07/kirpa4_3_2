...
import 'package:kirpa/screens/product/widgets/product_image_popup.dart';
import 'package:kirpa/store/setting/setting_store.dart';
import 'package:kirpa/utils/utils.dart';
import 'package:kirpa/widgets/cirilla_sirv_image.dart';
...
class _ProductSlideshowState extends State<ProductSlideshow> with ProductSlideshowPagination, Utility, LoadingMixin {
  ...
  SwiperPlugin _buildPagination(BuildContext context) {
    ...
    Color colorIndicator = ConvertData.fromRGBA(indicatorColor, theme.dividerColor);
    Color colorIndicatorActive = ConvertData.fromRGBA(indicatorActiveColor, theme.dividerColor);
