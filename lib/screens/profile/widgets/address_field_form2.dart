...
class AddressFieldForm2 extends StatefulWidget {
  ...
  @override
  State<AddressFieldForm2> createState() => _AddressFieldForm2();
}

class _AddressFieldForm2 extends State<AddressFieldForm2> with Utility {
  ...
  Widget build(BuildContext context) {
    ...
    String? countryId = get(widget.data, ['country'], '');
    String? stateId = get(widget.data, ['state'], '');
          ...
          ...List.generate(fields.keys.length, (index) {
            ...
            if (type == 'state') {
              return Padding(
                ...
                child: AddressFieldState(
                  ...
                  requiredInput: requiredInput,
                  borderFields: widget.borderFields,
                  onChanged: (String value) => widget.onChanged({...?widget.data, 'state': value}),
                  validator: validatorInput(keyField, requiredInput!, translate),
                  states: states,
                  stateId: stateId,
                  focusNode: _stateFocusNode,
            ...
            return Padding(
              ...
              child: AddressFieldText(
                ...
                validate: validate,
                borderFields: widget.borderFields,
                onChanged: (String value) => widget.onChanged({...?widget.data, keyField: value}),
              ),
            );
          }),
        ],
