...
import 'package:kirpa/screens/cart/cart_free_shipping_banner.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return StickableScreen(
      sticker: List.generate(itemStickyBanner.length, (index) {
        ...
        bool enableFreeShippingBanner = get(data, ['enableFreeShippingBanner'], false);

        Widget child;

        if (enableFreeShippingBanner) {
          child = SizedBox(
            width: imageSize.width,
            height: imageSize.height,
            child: FreeShippingBanner(
              key: _bannerKeys.putIfAbsent(index, () => GlobalKey()),
              onDismiss: () {},
            ),
          );
        } else {
