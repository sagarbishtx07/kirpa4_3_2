...
abstract class VariationStoreBase with Store {
  ...
  @observable
  ObservableMap<String, dynamic> _selectedImage = ObservableMap<String, dynamic>.of({});
  ...
  @computed
  ObservableMap<String, dynamic> get selectedImage => _selectedImage;
  ...
  void selectImage({String? value}) {
    if (findVariation['id'] == 0) {
      _selectedImage.addAll({
        "src": value ?? '',
        "medium_large": value ?? '',
      });
    } else {
      _selectedImage = ObservableMap<String, dynamic>.of({});
    }
  }
