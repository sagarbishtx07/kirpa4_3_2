...
mixin _$ProductsStore on ProductsStoreBase, Store {
  ...
  late final _$_filterStoreAtom = Atom(name: 'ProductsStoreBase._filterStore', context: context);
  ...
  late final _$fetchProductsFutureAtom = Atom(name: 'ProductsStoreBase.fetchProductsFuture', context: context);
  ...
  late final _$_productsAtom = Atom(name: 'ProductsStoreBase._products', context: context);
  ...
  late final _$_brandAtom = Atom(name: 'ProductsStoreBase._brand', context: context);
  ...
  late final _$pendingAtom = Atom(name: 'ProductsStoreBase.pending', context: context);
  ...
  late final _$_nextPageAtom = Atom(name: 'ProductsStoreBase._nextPage', context: context);
  ...
  late final _$_perPageAtom = Atom(name: 'ProductsStoreBase._perPage', context: context);
  ...
  late final _$_includeAtom = Atom(name: 'ProductsStoreBase._include', context: context);
  ...
  late final _$_excludeAtom = Atom(name: 'ProductsStoreBase._exclude', context: context);
  ...
  late final _$_tagAtom = Atom(name: 'ProductsStoreBase._tag', context: context);
  ...
  late final _$_canLoadMoreAtom = Atom(name: 'ProductsStoreBase._canLoadMore', context: context);
  ...
  late final _$_searchAtom = Atom(name: 'ProductsStoreBase._search', context: context);
  ...
  late final _$_currencyAtom = Atom(name: 'ProductsStoreBase._currency', context: context);
  ...
  late final _$_languageAtom = Atom(name: 'ProductsStoreBase._language', context: context);
  ...
  late final _$_sortAtom = Atom(name: 'ProductsStoreBase._sort', context: context);
  ...
  late final _$_vendorAtom = Atom(name: 'ProductsStoreBase._vendor', context: context);
  ...
  late final _$nextPageAsyncAction = AsyncAction('ProductsStoreBase.nextPage', context: context);
  ...
  late final _$getProductsAsyncAction = AsyncAction('ProductsStoreBase.getProducts', context: context);
  ...
  late final _$ProductsStoreBaseActionController = ActionController(name: 'ProductsStoreBase', context: context);

  @override
  Future<List<Product>> refresh({CancelToken? token}) {
    final _$actionInfo = _$ProductsStoreBaseActionController.startAction(name: 'ProductsStoreBase.refresh');
    try {
  ...
  @override
  void onChanged({Map<dynamic, dynamic>? sort, String? search, int? perPage, FilterStore? filterStore}) {
    final _$actionInfo = _$ProductsStoreBaseActionController.startAction(name: 'ProductsStoreBase.onChanged');
    try {
      return super.onChanged(sort: sort, search: search, perPage: perPage, filterStore: filterStore);
    } finally {
      _$ProductsStoreBaseActionController.endAction(_$actionInfo);
    }
  }
