...
mixin _$VariationStore on VariationStoreBase, Store {
  ...
  ObservableMap<String?, String?> get selected => (_$selectedComputed ??=
      ...
      .value;
  Computed<ObservableMap<String, dynamic>>? _$selectedImageComputed;

  @override
  ObservableMap<String, dynamic> get selectedImage =>
      (_$selectedImageComputed ??= Computed<ObservableMap<String, dynamic>>(
              () => super.selectedImage,
              name: 'VariationStoreBase.selectedImage'))
          .value;
  ...
  late final _$_selectedImageAtom =
      Atom(name: 'VariationStoreBase._selectedImage', context: context);

  @override
  ObservableMap<String, dynamic> get _selectedImage {
    _$_selectedImageAtom.reportRead();
    return super._selectedImage;
  }

  @override
  set _selectedImage(ObservableMap<String, dynamic> value) {
  ...
  void selectImage({String? value}) {
    final _$actionInfo = _$VariationStoreBaseActionController.startAction(
        name: 'VariationStoreBase.selectImage');
    try {
      return super.selectImage(value: value);
    } finally {
      _$VariationStoreBaseActionController.endAction(_$actionInfo);
    }
  }
