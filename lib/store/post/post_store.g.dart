...
mixin _$PostStore on PostStoreBase, Store {
  ...
  late final _$_customQueryAtom =
      Atom(name: 'PostStoreBase._customQuery', context: context);

  @override
  Map<String, dynamic> get _customQuery {
    _$_customQueryAtom.reportRead();
    return super._customQuery;
  }

  @override
  set _customQuery(Map<String, dynamic> value) {
    _$_customQueryAtom.reportWrite(value, super._customQuery, () {
      super._customQuery = value;
    });
  }
