...
class _PostArchiveWidgetState extends State<PostArchiveWidget> with Utility, NavigationMixin, ContainerMixin {
            ...
            title: RichText(
              text: TextSpan(
                  ...
                  children: enableCount!
                      ? [
                          const TextSpan(text: '   '),
                          TextSpan(text: '(${item.posts})', style: theme.textTheme.bodySmall),
                        ]
                      : null,
