...
import 'package:kirpa/widgets/cirilla_product_category_item.dart';
...
class _ProductCategoryWidgetState extends State<ProductCategoryWidget> with CategoryMixin, Utility, ContainerMixin {
    ...
    return Observer(
      builder: (_) {
        ...
        return Container(
          ...
          decoration: decorationColorImage(color: background,image: backgroundImage),
